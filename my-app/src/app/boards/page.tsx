...
import { FetchBoardsCountDocument, FetchBoardsDocument } from '@/commons/gql/graphql';
...
import Pagination from '@/components/board/boards-list/pagination';
import { useQuery } from '@apollo/client';
import styles from './styles.module.css';
import { useState } from 'react';
import { usePagination } from '@/components/board/boards-list/pagination/hook';
import SearchBar from '@/components/board/boards-list/search';
import { useSearchBar } from '@/components/board/boards-list/search/hook';
      ...
      <div className={styles.boardBody}>
        <div className={styles.boardContainer}>
          ...
          <div className={styles.boardFrame}>
            <BoardList search={search} page={currentPage} data={data} refetch={refetch} />
            <Pagination page={currentPage} data={data} refetch={refetch} lastPage={lastPage} />
          </div>
        </div>
      </div>
    </>
